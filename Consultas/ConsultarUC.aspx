...
--%>
<%-- FON_CGC-947 - INICIO --%>
<%@ page language="C#" masterpagefile="~/MasterPages/Logon.master" autoeventwireup="true" inherits="Inventario_ConsultaUC, App_Web_5aa3b1an" enableeventvalidation="false" theme="Default" %>
<%-- <%@ Page Language="C#" MasterPageFile="~/MasterPages/Logon.master" AutoEventWireup="true" CodeFile="ConsultarUC.aspx.cs" Inherits="Inventario_ConsultaUC" %> --%>
<%-- FON_CGC-947 - FIN --%>
            ...
            <td class="style18" colspan="3">
                ...
                Font-Size="X-Small" ForeColor="#333333" GridLines="None" Width="627px" 
                    ...
                    <Columns>
                        ...
                        <asp:CommandField ButtonType="Image" EditImageUrl="~/Img/codbar.jpg" 
                            EditText="Imprimir Codigo de Barras" ShowEditButton="True" />
                    </Columns>
