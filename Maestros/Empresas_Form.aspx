<%@ page language="C#" masterpagefile="~/MasterPages/Logon.master" autoeventwireup="true" inherits="Maestros_Empresas_Form, App_Web_pwkqaq54" title="Empresas" theme="Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <anthem:Panel ID="pnl_Grid" runat="server" Width="100%" Height="100%">
        <table style="width: 100%">
            ...
            <tr>
                <td style="width: 100%">
                    <anthem:GridView Width="95%" ID="gvw_Datos" runat="server" ForeColor="#747474" AutoGenerateColumns="False"
                        CellPadding="4" DataKeyNames="IdEmpresa" EmptyDataText='No se encontraron registros, pulse el boton "Nuevo " para agregar un registro'
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="IdEmpresa" HeaderText="Codigo">
                                <ItemStyle Width="60px" />
                            </asp:BoundField>
                ...
                <td>
                    <table style="width: 90%">
                        ...
                        <tr style="height: 25px">
                            <td align="left">
                                <anthem:Label ID="Label11" runat="server"  Text="Razon" Width="72px"></anthem:Label>
                            </td>
                            <td align="left">
                                <anthem:TextBox ID="txt_Razon" runat="server" Width="180px" OnTextChanged="TextBox6_TextChanged"
                                     MaxLength="49"></anthem:TextBox>
                                <anthem:RequiredFieldValidator ID="rfv1" runat="server" ControlToValidate="txt_Razon"
                                    Display="None" ErrorMessage="Ingrese razon" ></anthem:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr style="height: 25px">
                            <td align="left">
                                <anthem:Label ID="Label3" runat="server"  Text="Alias" Width="72px"></anthem:Label>
                            </td>
                            <td align="left">
                                <anthem:TextBox ID="txt_Alias" runat="server" Width="180px" OnTextChanged="TextBox6_TextChanged"
                                     MaxLength="49"></anthem:TextBox>
                                <anthem:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txt_Alias"
                                    Display="None" ErrorMessage="Ingrese alias" ></anthem:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr style="height: 25px">
                            <td align="left">
                                <anthem:Label ID="Label4" runat="server"  Text="Estado" Width="72px"></anthem:Label>
                            </td>
                            <td align="left">
