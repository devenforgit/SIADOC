<%@ page language="C#" masterpagefile="~/MasterPages/Logon.master" autoeventwireup="true" inherits="Maestros_Gerencias_Form, App_Web_pwkqaq54" title="Gerencias" theme="Default" %>
            ...
            <tr>
                <td style="width: 100%">
                    <anthem:GridView Width="500px" ID="gvw_Datos" runat="server" 
                        ...
                        CellPadding="4" DataKeyNames="IdGerencia" EmptyDataText='No se encontraron registros, pulse el boton "Nuevo " para agregar un registro'
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="IdGerencia" HeaderText="Codigo">
                                <ItemStyle Width="60px" />
                            </asp:BoundField>
                        ...
                        <tr style="height: 25px">
                            ...
                            <td align="left">
                                ...
                                <anthem:RequiredFieldValidator ID="rfv1" runat="server" ControlToValidate="txt_Descripcion"
                                    Display="None" ErrorMessage="Ingrese descripcion de Modulos" ></anthem:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td style="height: 20px">
