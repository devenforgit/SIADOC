<%@ page language="C#" masterpagefile="~/MasterPages/Logon.master" autoeventwireup="true" inherits="Maestros_MaeArchivo_Form, App_Web_pwkqaq54" title="SubSeries Documentales" theme="Default" %>
            ...
            <tr>
                <td style="width: 100%; text-align: center;">
                    <anthem:GridView Width="95%" ID="gvw_Datos" OnRowCreated="gvw_Datos_RowCreated" runat="server"
                        ForeColor="#747474" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="IdSubSerie"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="IdSubSerie" HeaderText="Codigo" />
                            <asp:BoundField DataField="Descripcion" HeaderText="SubSerie" />
                            <asp:BoundField DataField="IdSerie" HeaderText="IdSerie" />
                ...
                <td>
                    ...
                    <table style="width: 90%">
                        <tr style="height: 25px">
                            <td align="left">
                                <anthem:Label ID="Label11" runat="server" Text="SubSerie :" Width="72px"></anthem:Label>
                            </td>
                            <td align="left">
                                ...
                                <anthem:RequiredFieldValidator ID="rfv1" runat="server" ControlToValidate="txt_Descripcion"
                                    Display="None" ErrorMessage="Ingrese SubSerie"></anthem:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr style="height: 25px">
                            <td align="left">
                                <anthem:Label ID="Label3" runat="server" Text="Serie :" Width="72px" 
                                    Height="16px"></anthem:Label>
                            </td>
                            <td align="left">
                                <anthem:DropDownList ID="ddl_Serie" runat="server" Width="177px">
                                </anthem:DropDownList>
                                <anthem:RequiredFieldValidator ID="rfv4" runat="server" ControlToValidate="ddl_Serie"
                                    Display="None" ErrorMessage="Seleccione Serie"></anthem:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr style="height: 25px">
                            <td align="left">
                                <anthem:Label ID="Label1" runat="server" Text="Estado :" Width="72px"></anthem:Label>
                            </td>
                            <td align="left">
