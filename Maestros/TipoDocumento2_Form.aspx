<%@ page language="C#" masterpagefile="~/MasterPages/Logon.master" autoeventwireup="true" inherits="Maestros_TipoDocumento2_Form, App_Web_pwkqaq54" title="Tipo Documento" theme="Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <anthem:Panel ID="pnl_Grid" runat="server" Width="100%" Height="100%">
        <table style="width: 100%">
            ...
            <tr>
                <td style="width: 100%">
                    <anthem:GridView Width="500px" ID="gvw_Datos" 
                        OnRowCreated="gvw_Datos_RowCreated" runat="server"
                        ForeColor="#333333" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="IdTipo"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="IdTipo" HeaderText="Codigo" />
