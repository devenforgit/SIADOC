<%@ page language="C#" masterpagefile="~/MasterPages/Logon.master" autoeventwireup="true" inherits="Maestros_TipoDocumento_Form, App_Web_pwkqaq54" title="Tipo Documento" theme="Default" %>
        ...
        <table style="width: 100%">
            <tr align="left">
                <td align="left">
                    ...
                    <anthem:Button  Visible=false ID="btn_Delete" runat="server" Text="Eliminar"
            ...
            <tr>
                <td style="width: 100%">
                    <anthem:GridView Width="95%" ID="gvw_Datos" OnRowCreated="gvw_Datos_RowCreated" runat="server"
                        ForeColor="#333333" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="IdTipoDocumento"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="IdTipoDocumento" HeaderText="Codigo" />
                ...
                <td>
                    <table style="width: 90%">
                        <tr>
                            ...
                            <td align="left">
                                <anthem:TextBox  ReadOnly="true" ID="txt_Codigo" runat="server"
                                    Width="180px" MaxLength="49" Enabled="False"></anthem:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr style="height: 25px">
                            ...
                            <td align="left">
                                <anthem:DropDownList ID="ddl_Modulos" runat="server" >
                                </anthem:DropDownList>
