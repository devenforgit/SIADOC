<%@ page language="C#" masterpagefile="~/MasterPages/Logon.master" autoeventwireup="true" validaterequest="false" inherits="DocumentosSTD_Form, App_Web_rn5pk5zs" title=" .: SIADOC - Solicitar Préstamo de Documento :." theme="Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="text-align: center">
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
            <tr>
                <td colspan="2">
                    <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="Small" Text="Registro de Documentos del STD "
            ...
            <tr style="background: #E2DED6; height: 20px">
                <td colspan="2">
                    <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Small" Text="Filtros para consulta en el STD"
                        Width="314px"></asp:Label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 100px; height: 1px">
                    <anthem:Button ID="btnBuscar" EnabledDuringCallBack="false" TextDuringCallBack="Cargando..."
                        runat="server" Text="Buscar" CausesValidation="false" OnClick="Button1_Click" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 100px; height: 1px">
                    <anthem:Button ID="btnRegistrar" runat="server" Text="Registrar" OnClick="btnRegistrar_Click" />
                </td>
            </tr>
        </table>
